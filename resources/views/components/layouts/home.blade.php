...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('assets') }}/landrick/css/bootstrap-green.min.css" id="bootstrap-style" class="theme-opt"
    ...
    <link href="{{ asset('assets') }}/landrick/css/style-green.min.css" id="color-opt" class="theme-opt"
        rel="stylesheet" type="text/css" />
