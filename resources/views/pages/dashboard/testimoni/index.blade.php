<x-layouts.dashboard>
    <h1 class="app-page-title">Testimoni</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-description" align="right">
                        <a href="{{ route('testimoni.create') }}" class="btn text-white" style="background-color: #222222">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="_table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="35%">Jabatan</th>
