<x-layouts.dashboard>
    <h1 class="app-page-title">Fitur</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-description" align="right">
                        <a href="{{ route('fitur.create') }}" class="btn text-white" style="background-color: #222222">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="_table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">Rincian</th>
                                </tr>
                            </thead>
                            <tbody>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.delete-button', function (e) {
        ...
        Swal.fire({
            title: 'Hapus Fitur?',
            text: 'Apakah Anda yakin ingin menghapus fitur ini?',
            icon: 'warning',
